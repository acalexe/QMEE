...
Colocalization (<25% volume or >25% volume): when 3D segmented VIAAT-positive and VGLUT3-positive signals overlapped, I quantized the colocalization occurrence based on the % volume overlap between VIAAT-positive and VGLUT3-positive signals. I split the colocalization instances based on the % volume colocalized, with a 25% overlap threshold. 
